...
Street 📍 — улицы района (3 записи)
Profession 👔 — профессии (3 записи)
Book 📚 — книги-источники (3 записи)
Event 📅 — исторические события (195 записей)
Person 👤 — биографии персон (208 записей)
Keyword 🏷️ — теги для классификации (2 записи)

6 промежуточных моделей (связывают основные):

Person_event — связь Персона ↔ Событие
Person_keyword — связь Персона ↔ Тег
Event_keyword — связь Событие ↔ Тег
Person_book — связь Персона ↔ Книга
Event_book — связь Событие ↔ Книга
Person_profession — связь Персона ↔ Профессия
Person_street — связь Персона ↔ Улица


🎯 ЧТО ОНИ ДЕЛАЮТ:
Event (Событие) — главная модель

Хранит название, дату, описание, фото события
Связана с улицей (где произошло)
Связана с персонами (кто участвовал)
Связана с книгами (где описано)
Связана с тегами (тематика)

Person (Персона) — главная модель

Хранит ФИО, даты жизни, биографию, фото
Связана с событиями (в которых участвовала)
Связана с профессиями (кем была)
Связана с улицами (где жила/работала)
Связана с книгами (где описана)
Связана с тегами (тематика)

Остальные модели — справочники

Street, Book, Keyword, Profession — просто списки
